...
class RNNModel(nn.Module):
    ...
    def forward(self, input_ids):
        ...
        # RNN forward
        rnn_out, _ = self.rnn(embedded)  # (batch_size, seq_len, hidden_dim * num_directions)
        ...
        last_outputs = rnn_out[batch_indices, lengths]  # (batch_size, hidden_dim * num_directions)
